...
export default function Agent() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      console.error("A problem occurred adding or updating an agent: ", error);
    } finally {
      setForm({ name: "", rating: "", fee: "", region: "" });
    }
  }
  ...
  return (
    <>
      {showAlert && (
        <Alert variant="success" className="w-full max-w-lg text-center mb-4">
          Employee Agent saved successfully! Redirecting to login page in 5
          seconds.
        </Alert>
      )}
